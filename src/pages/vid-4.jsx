        ...
        <div className="max-w-8xl container relative mx-auto">
          <div className="flex flex-wrap items-center">
            ...
            >
              ...
              >
                ¿Por qué mi compost huele feo?<br />
              </Typography>
              <Typography variant="lead" color="white" className="opacity-80">
                Tres problemas comunes que se pueden presentar a la hora de hacer compost.<br /><br />
              </Typography>
              <Suspense fallback={<LoadingSpinner />}>
                <div className="videoWrapper">
                  <iframe
                    src="https://www.youtube.com/embed/66FVfIia3TQ?si=nDKHFuNjFdNbzB4X"></iframe>
                </div>
              </Suspense>
            </motion.div>
          </div>
